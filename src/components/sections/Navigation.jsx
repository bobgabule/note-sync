...
const Navigation = () => {
  ...
  return (
    <nav className="text-primary-50 m-auto flex justify-between items-center max-w-[90rem] px-24 text-lg/8 font-light max-xl:px-16 max-xl:text-base/loose max-lg:px-8">
