    ...
    >
      ...
      >
        <div>
          ...
          <ul className="mt-16 flex flex-col gap-y-6">
            { navigationLinks.map(( link ) => {
              return (
                <li key={link.id}>
                  <a className="text-primary-50 hover:text-primary-500 tranision-properties text-lg/8" href={link.href}>
                    {link.link}
                  </a>
                </li>
              )
        ...
        <div className="flex flex-col gap-y-3">
          ...
          >Login</button>
          <button
            className="bg-primary-500 border-primary-500 text-primary-1300 primary-glow hover:border-primary-50 hover:bg-primary-50 primary-glow-hover transition-properties cursor-pointer rounded-full border-2 px-6 py-3 text-base/loose"
