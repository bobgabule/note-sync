        ...
        <div className="text-primary-50 flex flex-col gap-y-6 text-lg/8 font-semibold tracking-tight">
          <label>
            ...
            <input
              ...
              className="bg-primary-75 placeholder-primary-1500 text-primary-1500 mt-2 block w-full rounded-full px-8 py-4 font-normal placeholder:text-base placeholder:font-light placeholder:opacity-50"
          />
          </label>
          <label>
            Password
